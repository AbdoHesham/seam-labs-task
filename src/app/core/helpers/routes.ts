export class routes {
  ...
  public static get company(): string {
    return this.core + '/assigned-company';
  }
  
 
  public static get authoritiesAndPrivileges(): string {
    return this.core + '/authorities-and-privileges';
  }
  public static get OrderTypes(): string {
    return this.core + '/order-types';
  }
  ...
  public static get subItemList(): string {
    return this.product + '/sub-item-list';
  }

  public static get editSubItem(): string {
    return this.product + '/edit-sub-item';
  }

  public static get addSubItem(): string {
    return this.product + '/add-sub-item/0';
  }
  ...
  public static get uomList(): string {
    return this.product + '/uom-list';
  }
  ...
  public static get addPurchase(): string {
    return this.purchase + '/add-purchase/0';
  }
  ...
  public static get createExpense(): string {
    return this.expense + '/create-expense/0';
  }
  ...
  public static get addQuotation(): string {
    return this.quotation + '/add-quotation/0';
  }
  public static get editQuotation(): string {
    return this.quotation + '/edit-quotation';
  }
  public static get companyInformation(): string {
    return this.company + '/companyinformation';
  }
  public static get editCompany(): string {
    return this.company + '/edit';
  }
  public static get editSetting(): string {
    return this.company + '/editSetting';
  }
  ...
  public static get authoritiesAndPrivilegesList(): string {
    return this.authoritiesAndPrivileges + '/list';
  }
  public static get addAuthoritiesAndPrivileges(): string {
    return this.authoritiesAndPrivileges + '/create/0';
  }
  
  public static get OrderTypesList(): string {
    return this.OrderTypes + '/list';
  }
  public static get addOrderTypes(): string {
    return this.OrderTypes + '/create/0';
  }
